...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen pb-[300px]">
          ...
          <div className="container px-4 py-8">
            ...
            <div className="mx-auto mt-16 max-w-3xl text-center">
              ...
              <p className="mt-6 text-lg text-gray-300">
                ConnectX transforms the way you interact with your Instagram followers. Easily increase engagement and
                automate responses to transform experiences into successful company prospects.
              </p>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-800">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <h2 className="text-3xl font-bold tracking-tighter text-white sm:text-5xl">What Our Users Say</h2>
            <p className="max-w-[900px] text-gray-400">
              Hear from content creators who have transformed their Instagram engagement with ConnectX
            </p>
          </div>
          ...
          <div className="mt-12 text-center">
            <Button className="bg-green-500 text-white hover:bg-green-600">Read More Success Stories</Button>
          </div>
        </div>
      </section>
