        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <p className="text-lg text-gray-300 mb-4">
              ConnectX was founded in 2023 with a mission to revolutionize how businesses interact with their audience
              on Instagram. Our AI-powered platform enables effortless engagement, ensuring no message goes unanswered.
            </p>
            <p className="text-lg text-gray-300 mb-6">
              With a team of dedicated professionals and cutting-edge technology, we're committed to helping businesses
